...
<html>
    ...
    <footer>
        <div  class="colored-line">
            <h5>Design and developed by Mr.Santhosh G &copy;2023</h5>
        </div>
    </footer>
...
<html>
    ...
    <div class="person">
        <li> <img src="./photo.png" class="bod"></br><span> &nbsp;&nbsp;&nbsp;Harish</span><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CEO</p></li>
        ...
        <li> <img src="./logo1.jpeg" class="bod" ></br><span>&nbsp;&nbsp;&nbsp;Doramen</span><p>&nbsp;&nbsp;&nbsp;&nbsp;Director</p></li>
        <li> <img src="./motu.jpeg "class="bod"></br><span>&nbsp;&nbsp;&nbsp;Motu-paltu</span><p>&nbsp;&nbsp;&nbsp;&nbsp;Assi Director</p></li>
        <li> <img src="./shinchan.jpeg "class="bod"></br><span>&nbsp;&nbsp;&nbsp;ShinChan</span><P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MD</P></li>
    </div>
    <footer>
    <div  class="colored-line">
        <h5>Design and developed by Mr.Santhosh G &copy;2023</h5>
...
<html>
    ...
    <footer>
        <div  class="colored-line">
            <h5>Design and developed by Mr.G.santhosh &copy;2023</h5>
        </div>
    </footer>
...
<footer>
    <div  class="colored-line">
        <h5>Design and developed by G.santhosh &copy;2023</h5>
    </div>
</footer>
